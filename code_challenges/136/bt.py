...
def check_bt(donor, recipient):
    ...
    # Validate arg in range if arg is int
    ...
    # Validate arg in blood_type_test.keys() if arg is str
    ...
    # Use int value of Bloodtype for compatibility check
    ...
    if donor == Bloodtype.ZERO_NEG or recipient == Bloodtype.AB_POS:
        return True
    # if negative, there is no compatibility
    elif -1 in _particular_antigen_comp(donor, recipient):
        return False
    else:
        return True
